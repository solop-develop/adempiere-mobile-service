 ...
 ************************************************************************************/
package org.spin.mobile_service.setup;
...
//		Ini.setProperty(Ini.P_ADEMPIERE_APPS_TYPE, "wildfly");
	...
	/**
	 * @return
	 * @see org.spin.mobile_service.setup.SetupWrapper#getDatabase()
	 */
	...
	/**
	 * @return
	 * @see org.spin.mobile_service.setup.SetupWrapper#getServer()
	 */
